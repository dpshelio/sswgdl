...
; - change nsat, add the calibration data to the goes_tf_coeff, goes_tf routines
...
gbshort = 1e-5*[1.27,1.25,1.25,1.73,1.74,1.74,1.68,1.580,1.607,1.631,1.608,1.595,1.560,1.560] 
gblonga = 1e-6*[4.09,3.98,3.98,4.56,4.84,5.32,4.48,4.165,3.990,3.824,4.377,4.090,4.167,4.167] 
...
if satnum lt 1 or satnum gt 14 then begin 
  print,'Only satellite numbers 1 - 14 are presently supported!' 
  goto,exit 
  endif 
...
pro make_goes_chianti_response
 ...
 nsat=14             ; current number of satellites in goes_tf_coeff
 fold_spec_resp, nsat
