...
imap=strupcase([sinstr,yinstr,smminstr,radinstr,optinstr,packinstr,spinstr,trinstr,hsinstr,csinstr,hxinstr,smeinstr,goesinstr,vobsinstr,sterinstr,hinodeinstr,proba2instr,sdoinstr])
