...
function eve::search,tstart,tend,_ref_extra=extra,count=count,type=type,$
                     times=times
...
files=sock_files(server,dstart,dend,path=path,org='doy',/no_filter,_extra=extra,count=count)
...
err='SDO/EVE reader currently available.'
message,err,/cont
